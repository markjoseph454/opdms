	...
	var incomerow = $('<tr class="incomerow">' +
		                '<td><div class="col-md-6" style="padding: 0px;">' +
		                        '<select class="form-control category" name="category[]" required>' +
		                             ...
		                             '<option value="10" >OPD LABORATORY</option>' +   
		                ...
		                '<td width="10%"><input type="text" name="item_netamount[]" class="form-control item_netamounti" readonly></td>' +
...
function chargelist(charges){
	...
	var incomerow = $('<tr class="incomerow">' +
		                ...
		                '</td>' +
		                '<td width="10%"><input type="text" name="item_price[]" class="form-control item_pricei" value='+charges[s].price.toFixed(2)+' required></td>' +
		                '<td width="10%"><input type="number" name="item_qty[]" class="form-control item_qtyi" value='+charges[s].qty+'  required></td>' +
		                '<td width="10%"><input type="text" name="item_amount[]" class="form-control item_amounti" value='+charges[s].amount.toFixed(2)+' readonly></td>' +
		                '<td width="10%"><input type="text" name="item_discount[]" class="form-control item_discounti" value='+Number(charges[s].discount).toFixed(2)+' ></td>' +
		                '<td width="10%"><input type="text" name="item_netamount[]" class="form-control item_netamounti"  value='+charges[s].netamount.toFixed(2)+' readonly></td>' +
		                '<td align="center" width="5%"><span class="glyphicon glyphicon-remove-circle removeincome" type="button" style="margin-top: 40%;color: red;cursor: pointer;"></span></td>' +
		            '</tr>');
