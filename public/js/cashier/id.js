    ...
    $.post(baseUrl+"/getpatientbyid", {
        ...
        function (data, status){
          ...
          var request = JSON.parse(data);
            ...
            var td2 = $('<td align="right" width="100px">').text('50.00');
            var td3 = $('<td align="center" width="50px">').text('1');
            var td4 = $('<td align="right" width="100px">').text('50.00');
            var td5 = $('<td align="right" width="100px">').text('0.00');
            var td6 = $('<td align="right" width="100px">').text('50.00');
            var tr = $('<tr/>');
            $(tr).append(td1, td2, td3, td4, td5, td6);
            $('.itemsbody').append(tr);
            $('.tot_amount').val('50.00');
            $('.tot_discount').val('0.00');
            $('.tot_payment').val('50.00');
            $('.change').val('50.00');

            var idinput = $('<input type="hidden" name="patient_id"  value='+id+'>');
            var input1 = $('<input type="hidden" name="category_id"  value="1">');
            var price = $('<input type="hidden" name="price"  value="50.00">');
    ...
    $.post(baseUrl+"/getpatientbyid", {
        ...
        function (data, status){
          ...
          var request = JSON.parse(data);
            ...
            var tr = $('<tr>');
            var td1 = $('<td>').text('HOSPITAL ID');
            var td2 = $('<td align="right" width="100px">').text('100.00');
            var td3 = $('<td align="center" width="50px">').text('1');
            var td4 = $('<td align="right" width="100px">').text('100.00');
            var td5 = $('<td align="right" width="100px">').text('0.00');
            var td6 = $('<td align="right" width="100px">').text('100.00');
            var tr = $('<tr/>');
            $(tr).append(td1, td2, td3, td4, td5, td6);
            $('.itemsbody').append(tr);
            $('.tot_amount').val('100.00');
            $('.tot_discount').val('0.00');
            $('.tot_payment').val('100.00');
            $('.change').val('100.00');

            var idinput = $('<input type="hidden" name="patient_id"  value='+id+'>');
            var input1 = $('<input type="hidden" name="category_id"  value="1">');
            var price = $('<input type="hidden" name="price"  value="100.00">');
            $('.transaction-content').append(idinput, input1, price);
            $('#searchpatient-modal').modal("hide");  
            $('#reprint-modal').modal('hide'); 
            }
