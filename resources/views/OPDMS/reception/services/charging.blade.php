    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <a href="{{ url('services_offered') }}" target="_blank"
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a data-toggle="tab" href="#unpaid_tab">
                                    Unpaid Requests {{--<span class="badge bg-purple">3</span>--}}
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#paid_but_undone_tab">
                                    Paid but Undone Requests {{--<span class="badge">3</span>--}}
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="#paid_and_done_tab">
                                    Paid and Done Requests {{--<span class="badge bg-aqua">3</span>--}}
                                </a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div id="requisition_table" class="tab-pane fade in active">
                                <div class="table-responsive ancillary_services_wrapper">
                                    ...
                                    <form action="{{ url('charging_save') }}" method="post" id="charging_form"
