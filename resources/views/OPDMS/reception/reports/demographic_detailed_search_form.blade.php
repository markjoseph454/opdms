<div class="box-header with-border">
    <div class="row">
        ...
        <div class="col-md-9 text-right">
            <form action="{{ url('demographic') }}" method="post" class="form-inline" style="display: inline" onsubmit="full_loader()">
                {{ csrf_field() }}
                <div class="input-group">
                    ...
                    <input type="text" required name="starting" class="form-control datepicker1"
                           required placeholder="Starting date" value="{{ $starting }}">
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" required name="ending" class="form-control datepicker1"
                           required placeholder="Ending date" value="{{ $ending }}">
                </div>
