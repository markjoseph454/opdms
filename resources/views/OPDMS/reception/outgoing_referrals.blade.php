...
@section('vue-container-start')
    ...
    @section('content')
        ...
        <!-- Content Wrapper. Contains page content -->
            ...
            ['header' => 'Outgoing Referrals', 'sub' => 'Showing all patients that has been referred to other clinics.'])
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box box-default bg-danger">
                        ...
                        <div class="box-header with-border">
                                <form action="{{ url('outgoing_referrals') }}" method="get" class="form-inline">
                                    ...
                                    @if($queues)
                                        @foreach($queues as $queue)
                                            <tr v-on:click.prevent="patient_check($event, {{ $queue->pid }})">
                                                ...
                                                <td>
                                                    <strong class="text-primary text-uppercase">
                                                        DR. {{ $queue->u_last_name.', '.$queue->u_first_name }}
                                                    </strong>
                                                </td>
                                                <td>
                                                    {{ $queue->name }}
                                                ...
                                                <td>
                                                    {{ Carbon::parse($queue->created_at)->toFormattedDateString()}}
                                                    <br>
