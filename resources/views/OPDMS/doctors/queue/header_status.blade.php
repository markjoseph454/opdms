...
<div class="box-header with-border row">
    ...
    <div class="col-md-9">
        <a href="{{ url('queuing/P') }}" class="btn btn-flat {{ $pending_status }}"
        ...
        <a href="{{ url('queuing/H') }}" class="btn btn-flat {{ $paused_status }}"
           onclick="full_window_loader()">
            Paused
            <span class="badge bg-gray">
            {{ $paused_total or 0 }}
        ...
        <a href="{{ url('queuing/C') }}" class="btn btn-flat {{ $canceled_status }}"
        ...
        <a href="{{ url('queuing/S') }}" class="btn btn-flat {{ $serving_status }}"
           onclick="full_window_loader()">
            Serving
            <span class="badge bg-gray">
            {{ $serving_total or 0 }}
        ...
        <a href="{{ url('queuing/F') }}" class="btn btn-flat {{ $finished_status }}"
           onclick="full_window_loader()">
            Finished
            <span class="badge bg-gray">
            {{ $finished_total or 0 }}
        ...
        <a href="{{ url('queuing') }}" class="btn btn-flat {{ $all_status }}"
    ...
    <div class="col-md-3">
        <form action="{{ url('queuing_search') }}" method="get" class="" style="margin: 0">
