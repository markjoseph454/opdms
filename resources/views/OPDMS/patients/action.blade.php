<div class="box-header with-border">
    <div class="row">
        <div class="col-md-5 action-button">
            ...
            <button class="btn btn-success btn-sm" id="edit-button" data-id="#"><span class="fa fa-pencil"></span> Edit</button>
            <a href="#" class="btn btn-success btn-sm" id="print-button" data-id="#"><span class="fa fa-print"></span> Print</a>
            <button class="btn btn-primary btn-sm" id="print-multiple"><span class="fa fa-print"></span> Print Multiple</button>
            <button class="btn btn-danger btn-sm" id="remove-button" data-id="#"><span class="fa fa-trash"></span> Remove</button>
        </div>
        <div class="col-md-6 col-md-offset-1 action-search">
            ...
            <form class="form-search text-center" method="GET" action="">
                    <div class="input-group">
                          ...
                          <!-- /btn-group -->
                          <input type="text" name="patient" id="searchInput" class="form-control input-sm" placeholder="Search for hospital no, last name, first name, middle name..." autofocus/>
                    ...
                    <span class="fa fa-info-circle"></span> <small class="search-guide"> Search for hospital no, last name, first name, middle name</small>
                    <!-- /input-group -->
            </form>
        </div>
    </div>
...
<div class="btn-group-vertical trial-click">
  ...
  <a href="#" class="btn btn-default btn-sm"><span class="fa fa-file-text-o"></span> Medical Records</span></a>
