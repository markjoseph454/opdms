                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        @for($i=0;$i<12;$i++)
                            <tr>
                                <td>
                                    <input type="text" name="bro_sis{{ $i }}" class="smallInput" />
                                </td>
                                <td class="text-center">
                                    <label class="normalLabel"><input type="radio" name="gender{{ $i }}" value="M"> M</label>
                                    &nbsp; &nbsp; &nbsp; &nbsp;
                                    <label class="normalLabel"><input type="radio" name="gender{{ $i }}" value="F"> F</label>
                                </td>
                                <td>
                                    <input type="date" name="date_birth{{ $i }}" class="smallInput" />
                                </td>
                            </tr>
                        @endfor
                        </tbody>
                    ...
                    <table class="table table-bordered" id="essentialHealthTable">
                        ...
                        <tr>
                            ...
                            @for($i=0;$i<6;$i++)
                                <td @if($i>2) class="stripedLine" @endif>
                                    @if($i<3)
                                        <input type="date" name="pv{{ $i }}" class="smallInput" />
                                    @endif
                                </td>
                            @endfor
                        </tr>
                        <tr>
                            ...
                            @for($i=0;$i<6;$i++)
                                <td @if($i>2) class="stripedLine" @endif>
                                    @if($i<3)
                                        <input type="date" name="opv{{ $i }}" class="smallInput" />
                                    @endif
                                </td>
                            @endfor
                        </tr>
                        ...
                        <tr>
                            ...
                            @for($i=0;$i<6;$i++)
                                <td>
                                    <input type="date" name="mmr_two{{ $i }}" class="smallInput" />
                                </td>
                            @endfor
                        </tr>
                        <tr>
                            ...
                            @for($i=0;$i<6;$i++)
                                <td>
                                    <input type="date" name="ipv{{ $i }}" class="smallInput" />
                                </td>
                            @endfor
                        </tr>
                        <tr>
                            ...
                            @for($i=0;$i<6;$i++)
                                <td>
                                    <input type="date" name="pcv{{ $i }}" class="smallInput" />
                                </td>
                            @endfor
                        </tr>
