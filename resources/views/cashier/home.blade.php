                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           ...
                           <div class="row search-section">
                            <form class="searchpatientbyhospital" method="post" action="{{ url('searchpatient') }}" onsubmit="searchpatient($(this))">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           ...
                           <div class="row search-section">
                            <form class="searchreprintid" method="post" action="{{ url('searchpatient') }}" onsubmit="searchreprintid($(this))">
                                <div class="col-md-7">
