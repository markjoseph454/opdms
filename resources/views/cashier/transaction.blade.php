...
@section('pagestyle')
    ...
    @endif
        ...
        <link href="{{ asset('public/css/cashier/jquery.datepicker.css') }}" rel="stylesheet" />
        <link href="{{ asset('public/css/cashier/transaction.css') }}" rel="stylesheet" />
    ...
    @component('cashier/dashboard')
        @section('main-content')
            <div class="container-fluid cashier-container" style="margin-top: 70px;">
                ...
                <div class="col-md-3">
                    <div class="row reciept-number">
                        <h3>{{ Carbon::now()->setTime(0,0)->format('m/d/Y') }}</h3>    
                    </div>
                                ...
                                <table class="table table-bordered" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="padding: 0px;">
                                            <button type="button" class="btn btn-default change-patient" data-id="" style="width: 100%;margin: 0px;"><span class="fa fa-user-o"></span> Change</button>
                                        </td>
                                        <td>CLASSIFICATION: <b class="classificationm"></b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" >CASHIER: <b>{{ strtoupper(Auth::user()->first_name.' '.substr(Auth::user()->middle_name,0,1).'. '.Auth::user()->last_name) }}</b></td>
            ...
            <div id="genarate-modal" class="modal" role="dialog">
                <div class="modal-dialog">
                    <form class="form-horizontal genarate" method="GET" target="_blank" action="{{ url('dailyreport') }}">
                        <div class="modal-content">
                            <div class="modal-header">
                                REPORT AUTHINTACATION
                            </div>
                            <div class="modal-body">
            ...
            @include('cashier.modals.reflect')
            @include('cashier.modals.changept')
...
@section('pagescript')
    ...
    <script src="{{ asset('public/js/cashier/jquery.datepicker.js') }}"></script>
    <script src="{{ asset('public/js/cashier/transaction.js') }}"></script>
