    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row diagnosisWrapper">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h2 class="text-center" style="display: inline">
                            DIAGNOSIS FORM <small>Patient Name: {{ $patient->last_name.', '.$patient->first_name.' '.$patient->middle_name[0].'.' }}</small>
                        </h2>
                    </div>
                ...
                <form action="{{ url('diagnosis') }}" method="post" id="diagnosisForm">
                    {{ csrf_field()  }}
