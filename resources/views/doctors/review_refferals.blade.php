...
@section('main-content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-left">REVIEW TODAYS REFFERAL</h3>
                </div>
                <br>
                <br>
                <br>
                            ...
                            @if(count($refferals) > 0)
                                @foreach($refferals as $refferal)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('refferal/'.$refferal->id.'/edit') }}" class="btn btn-info btn-circle">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ url('delete_refferal/'.$refferal->id) }}" class="btn btn-danger btn-circle" onclick="return confirm('Delete this refferal?')">
