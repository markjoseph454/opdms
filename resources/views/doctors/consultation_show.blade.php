            ...
            <br>
                <div class="previewHeaderWrapper">
                    <h2>
                        ...
                        <small>Patient: {{ $patient->last_name.', '.$patient->first_name.' '.$patient->middle_name[0].'.' }}</small>
                    </h2>
                    <div class="pull-right" style="display: inline">
                        ...
                        @php
                            $action = ($consultation->users_id == Auth::user()->id || $checkIfForApproval)? '' : 'disabled onclick="event.preventDefault()"';
                            $activateEdit = ($consultation->users_id == Auth::user()->id || $checkIfForApproval)? 'editConsultation' : '';
