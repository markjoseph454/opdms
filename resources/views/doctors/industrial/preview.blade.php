    ...
    <div class="content-wrapper" style="padding: 50px 0px" id="contentPatientList">
        ...
        <div class="container">
            ...
            <div class="text-right">
                <a href="{{ url('industrialPrint/'.$industrialConsultations->id) }}" target="_blank"
                   class="btn btn-info">Print <i class="fa fa-print"></i></a>
                <button type="submit" form="industrialMainForm" class="btn btn-success submitIndustrialBtn"
                        @if(Auth::user()->id != $industrialConsultations->user_id) disabled @endif>
                    Update Industrial Form <i class="fa fa-save"></i>
                </button>
            </div>
            <br/>
            ...
            <div id="industrialForm" class="industrialFormcLASS">
                ...
                <form action="{{ url('industrial') }}" method="post" id="industrialMainForm">

                    {{ csrf_field() }}

                    <input type="hidden" name="pid" value="{{ $patient->id }}"/>

                    <input type="hidden" name="industrialFormId" @if($industrialConsultations) value="{{ $industrialConsultations->id }}" @endif/>
                    ...
                    <div class="form-group">
                        <textarea name="result" id="" class="form-control" cols="30" rows="8">{{ $industrialConsultations->result or '' }}</textarea>
                        <br/>
    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="" target="_blank" class="btn btn-primary printIConIndustrial">Print <i class="fa fa-print"></i></a>
                <button type="submit" form="industrialMainForm" class="btn btn-success submitIndustrialBtn">
