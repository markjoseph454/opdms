...
@section('main-content')
    ...
    <div class="content-wrapper" style="margin-left: 150px;padding-right: 20px;">
        <br>
        <div class="banner">
            <h3 class="text-left"> <i class="fa fa-user-md"></i> UPDATE REQUISITION</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="row seletecItemsWrapper">
                    ...
                    <div class="table-responsive tableSelectedItems">
                        <form action="{{ url('updateunpaidancillaryrequisition') }}" method="post" id="requisitionformlab">
                            {{ csrf_field() }}
                    ...
                    <div class="col-md-12 grandtotalinfo">
                        <div class="col-md-4 col-md-offset-8 text-right">
                             ...
                             <a href="{{ url('unpaidtransaction') }}" class="btn btn-default btn-sm" onclick="$(this).css('cursor', 'wait')">CANCEL UPDATE</a>
                        </div>
                    </div>
                </div>
            </div>
