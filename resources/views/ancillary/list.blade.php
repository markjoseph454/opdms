                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                         ...
                         <div class="form-group">
                           ...
                           <textarea class="form-control" name="sub_category" autofocus placeholder="Enter Service Name/ Description"></textarea>
                         </div>
                         <div class="form-group row">
                            <div class="col-md-6">
                                  <label>Price</label>
                       ...
                       {{-- @if(Auth::user()->clinic == "31")
                        ...
                        @endif--}}
                         <div class="form-group">
                           ...
                           <textarea class="form-control sub_category" name="sub_category" autofocus></textarea>
                         </div>
                         <div class="form-group row">
                            <div class="col-md-6">
                                  <label>Price</label>
