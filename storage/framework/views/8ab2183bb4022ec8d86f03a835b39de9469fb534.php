                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-bordered" border="0">
                                    ...
                                    <tr>
                                        <td colspan="2" >CASHIER: <b><?php echo e(strtoupper(Auth::user()->first_name.' '.substr(Auth::user()->middle_name,0,1).'. '.Auth::user()->last_name)); ?></b></td>
...
<?php $__env->startSection('pagescript'); ?>
    ...
    <script src="<?php echo e(asset('public/js/cashier/transaction.js')); ?>"></script>
