...
<?php $__env->startSection('vue-container-start'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <!-- Content Wrapper. Contains page content -->
            ...
            ['header' => 'Follow-up Patients', 'sub' => 'Showing all patients that has a scheduled follow-up.'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box box-default bg-danger">
                        ...
                        <div class="box-header with-border">
                            <form action="<?php echo e(url('followup_notifications')); ?>" method="get" class="form-inline">
                                    ...
                                    <?php if($queues): ?>
                                        <?php $__currentLoopData = $queues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr v-on:click.prevent="patient_check($event, <?php echo e($queue->pid); ?>)">
                                                ...
                                                <td><?php echo e($queue->name); ?></td>
                                                <td>
                                                    
                                                    <strong class="text-primary text-uppercase">
                                                        <?php echo e($queue->u_last_name.', '.$queue->u_first_name.' '.
                                                        $queue->u_middle_name); ?>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($queue->ft_last_name): ?>
                                                        <strong class="text-primary text-uppercase">
                                                            <?php echo e($queue->ft_last_name.', '.$queue->ft_first_name.' '.
                                                            $queue->ft_middle_name); ?>

                                                        </strong>
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e($queue->reason); ?></td>
                                                <?php
                                                    if ($queue->status == 'F'){
                                                ...
                                                ?>
                                                <td>
                                                    <span class="label <?php echo e($status_color); ?>">
                                                        <?php echo e($status_text); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <?php echo e(Carbon::parse($queue->followupdate)->format('M d, Y')); ?>
