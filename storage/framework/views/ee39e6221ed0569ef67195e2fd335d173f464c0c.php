                ...
                <table class="table table-striped" id="watchertable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?php echo e(url('selectwatcher')); ?>/<?php echo e($request->ptid); ?>/<?php echo e($list->id); ?>" class="btn btn-success btn-sm"><span class="fa fa-arrow-right"></span> Select</a>
                            </td>
