...
<?php $__env->startSection('vue-container-start'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <!-- Content Wrapper. Contains page content -->
            ...
            ['header' => 'Incoming Referrals', 'sub' => 'Showing all patients that has been referred to this clinics.'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box box-default bg-danger">
                        ...
                        <div class="box-header with-border">
                            <form action="<?php echo e(url('incoming_referrals')); ?>" method="get" class="form-inline">
                                    ...
                                    <?php if($queues): ?>
                                        <?php $__currentLoopData = $queues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr v-on:click.prevent="patient_check($event, <?php echo e($queue->pid); ?>)">
                                                ...
                                                <td>
                                                    <?php echo e($queue->from_clinic); ?>

                                                </td>
                                                <td>
                                                    <strong class="text-primary text-uppercase">
                                                        DR. <?php echo e($queue->rb_last_name.', '.$queue->rb_first_name); ?>

                                                    </strong>
                                                </td>
                                                <td>
                                                    <?php echo e($queue->to_clinic); ?>

                                                </td>
                                                <td>
                                                    <?php if($queue->rt_last_name): ?>
                                                        <strong class="text-primary text-uppercase">
                                                            DR. <?php echo e($queue->rt_last_name.', '.$queue->rt_first_name); ?>
