    ...
    <?php $__env->startComponent('cashier/dashboard'); ?>
        <?php $__env->startSection('main-content'); ?>
            <div class="container-fluid cashier-container" style="margin-top: 70px;">
                <form class="submittransaction" method="post" target="_blank" action="<?php echo e(url('submittransaction')); ?>">
                <div class="col-md-9">
                        <div class="col-md-12">
...
<?php $__env->startSection('pagescript'); ?>
    ...
    <script src="<?php echo e(asset('public/js/cashier/main.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('public/js/cashier/income.js')); ?>"></script>
<?php $__env->stopSection(); ?>
