        ...
        <div class="table-responsive" id="otpc_back_table_div">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="date" name="date<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="weightKG<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="weightLoss<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="muac<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="edemaBack<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="length_height<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="whz<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="diarrheaDays<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="vomiting_days<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="fever_days<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="cough_days<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="temperatureDays<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="respirationRate<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="dehydrated<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="anemia<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="skin_infection<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="appetite_test_day<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="action_needed<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="appetite_test_pass_fail<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="other_medication<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="rutf<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="examiner<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
                    ...
                    <?php for($i=1;$i<18;$i++): ?>
                        <td>
                            <input type="text" name="outcome<?php echo e($i); ?>" class="smallInput" style="width: 100%">
                        </td>
                    <?php endfor; ?>
                </tr>
                <tr>
