        ...
        <div class="modal-content">
                ...
                <form action="<?php echo e(url('industrial')); ?>" method="post" id="industrialMainForm">
                    ...
                    <div class="col-md-12 row">
                        <div class="form-inline">
                            ...
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->bp); ?>" <?php endif; ?>/>
                            <label>mmHg,</label>
                            <strong class="strng">HR</strong>
                            <input type="text" name="hr" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->hr); ?>" <?php endif; ?>/>
                            <label>bpm,</label>
                            <strong class="strng">RR</strong>
                            <input type="text" name="rr" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->rr); ?>" <?php endif; ?>/>
                            <label>cpm,</label>
                            <strong class="strng">Temp</strong>
                            <input type="text" name="temp" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->temp); ?>" <?php endif; ?>/>
                            <label> &#176;C,</label>
                            <strong class="strng">BMI</strong>
                            <input type="text" name="bmi" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->bmi); ?>" <?php endif; ?>/>
                            <strong class="strng">WT.</strong>
                            <input type="text" name="wt" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->wt); ?>" <?php endif; ?>/>
                            <strong class="strng">HT.</strong>
                            <input type="text" name="ht" class="styledFormSmall"
                            <?php if($pe): ?> value="<?php echo e($industrialConsultations->physical_exams->ht); ?>" <?php endif; ?>/>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo e($href); ?>"
                   target="_blank" class="btn btn-primary printIConIndustrial">Print <i class="fa fa-print"></i>
                </a>
                <button type="submit" form="industrialMainForm" class="btn btn-success submitIndustrialBtn">
                    Save Industrial Form <i class="fa fa-save"></i>
                </button>
            </div>
        </div>
