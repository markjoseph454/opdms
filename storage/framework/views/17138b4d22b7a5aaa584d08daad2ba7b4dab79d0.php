<div class="box-header with-border">
    <form action="<?php echo e(url('medServicesAccomplished')); ?>" method="post" class="form-inline" role="form" onsubmit="full_loader()">
        ...
        <span class="input-group-addon" id="startingDate" onclick="document.getElementById('start').focus()">
            <i class="fa fa-calendar"></i>
                ...
                <input type="text" name="starting" class="form-control datepicker1" value="<?php echo e($starting); ?>"
        ...
        <span class="input-group-addon" id="endingDate" onclick="document.getElementById('ending').focus()">
            <i class="fa fa-calendar"></i>
                ...
                <input type="text" name="ending" class="form-control datepicker1" value="<?php echo e($ending); ?>"
