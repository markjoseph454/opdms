                ...
                <table class="table table-striped" id="services-table-table">
                    ...
                    <tbody class="services-tbody">
                        ...
                        <tr>
                            ...
                            <td class="sservice">Service <?php echo e($i); ?></td>
                            <td align="right" class="sprice"><?php echo e($i); ?>1.00</td>
                        </tr>
                        <?php endfor; ?> -->
                    </tbody>
                </table>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"> <span class="fa fa-history"></span> Patient History</h4>
      </div>
      <div class="modal-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tfoot>
                    <tr>
                        <th colspan="3"></th>
                        <th class="total_amount text-right" hidden></th>
                        <th class="total_discount text-right" hidden></th>
