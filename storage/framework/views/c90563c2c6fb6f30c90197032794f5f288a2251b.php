    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $__env->make('OPDMS.message.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                <form action="<?php echo e(url('services_store')); ?>" method="post" id="services_add_form">
