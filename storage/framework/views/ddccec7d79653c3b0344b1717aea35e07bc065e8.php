...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container" id="children_care">
        ...
        <form action="<?php echo e(url('save_early_childhood_care')); ?>" method="post" id="children_careForm">
            ...
            <input type="hidden" name="updateChildhoodCare" value="<?php echo e($data->id); ?>" />
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                Clinic:
                                <input type="text" name="clinic_name" value="<?php echo e($data->clinic_name); ?>" class="smallInput" />
                            </td>
                            <td colspan="3">
                                Childs No.:
                        ...
                        <tr>
                            <td colspan="3">
                                Family No.:
                                <input type="text" name="family" value="<?php echo e($data->family); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="3">
                                Mothers Name:
                                <input type="text" name="mother" value="<?php echo e($data->mother); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                Educational Level:
                                <input type="text" name="education" value="<?php echo e($data->education); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                Occupation:
                                <input type="text" name="occupation" value="<?php echo e($data->occupation); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Date First Seen:
                                <input type="date" name="date_first_seen" value="<?php echo e($data->date_first_seen); ?>" class="smallInput" />
                            </td>
                            <td>
                                Birth Date:
                            ...
                            <td>
                                Birth Weight:
                                <input type="text" name="birth_weight" value="<?php echo e($data->birth_weight); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Place of delivery:
                                <input type="text" name="place_of_delivery" value="<?php echo e($data->place_of_delivery); ?>" class="smallInput" />
                            </td>
                            <td colspan="2">
                                Birth registered at local civil registry (date):
                                <input type="text" name="birth_registered" value="<?php echo e($data->birth_registered); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">
                                Complete address of family (House No., Street, City/Province):
                                <input type="text" name="complete_address" value="<?php echo e($data->complete_address); ?>" class="smallInput" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <?php for($i=0;$i<12;$i++): ?>
                            <tr>
                                <td>
                                    <input type="text" name="bro_sis<?php echo e($i); ?>" value="<?php echo e($bro_sis[$i]); ?>" class="smallInput" />
                                </td>
                                <td class="text-center">
                                    <label class="normalLabel">
                                        <input type="radio" name="gender<?php echo e($i); ?>" value="M"
                                            <?php if($gender[$i] == 'M'): ?> checked <?php endif; ?>> M
                                    </label>
                                    &nbsp; &nbsp; &nbsp; &nbsp;
                                    <label class="normalLabel">
                                        <input type="radio" name="gender<?php echo e($i); ?>" value="F"
                                               <?php if($gender[$i] == 'F'): ?> checked <?php endif; ?>> F
                                    </label>
                                </td>
                                <td>
                                    <input type="date" name="date_birth<?php echo e($i); ?>" value="<?php echo e($date_birth[$i]); ?>" class="smallInput" />
                                </td>
                            </tr>
                        <?php endfor; ?>
                        </tbody>
                    ...
                    <table class="table table-bordered" id="essentialHealthTable">
                        ...
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>0): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<1): ?>
                                        <input type="date" name="newborn_screening" value="<?php echo e($data->newborn_screening); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>0): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<1): ?>
                                        <input type="date" name="bcg" value="<?php echo e($data->bcg); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>2): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<3): ?>
                                        <input type="date" name="pv<?php echo e($i); ?>" value="<?php echo e($pv[$i]); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>2): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<3): ?>
                                        <input type="date" name="opv<?php echo e($i); ?>" value="<?php echo e($opv[$i]); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>0): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<1): ?>
                                        <input type="date" name="hepatitis" value="<?php echo e($data->hepatitis); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td <?php if($i>0): ?> class="stripedLine" <?php endif; ?>>
                                    <?php if($i<1): ?>
                                        <input type="date" name="mmr_one" value="<?php echo e($data->mmr_one); ?>" class="smallInput" />
                                    <?php endif; ?>
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td>
                                    <input type="date" name="mmr_two<?php echo e($i); ?>" value="<?php echo e($mmr_two[$i]); ?>" class="smallInput" />
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td>
                                    <input type="date" name="ipv<?php echo e($i); ?>" value="<?php echo e($ipv[$i]); ?>" class="smallInput" />
                                </td>
                            <?php endfor; ?>
                        </tr>
                        <tr>
                            ...
                            <?php for($i=0;$i<6;$i++): ?>
                                <td>
                                    <input type="date" name="pcv<?php echo e($i); ?>" value="<?php echo e($pcv[$i]); ?>" class="smallInput" />
                                </td>
                            <?php endfor; ?>
                        </tr>
