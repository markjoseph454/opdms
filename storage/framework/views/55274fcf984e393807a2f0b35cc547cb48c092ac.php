                            ...
                            <li <?php echo $checkStst; ?>>
                                <a href='<?php echo e(url("approval/$patient->pid/$allDoctor->id")); ?>'>
                                    <?php if(App\User::isActive($allDoctor->id)): ?>
                                        <?php echo "<div class='online'></div> <span class='text-default'>Dr. $allDoctor->name</span>"; ?>

                                    <?php else: ?>
                                        <?php echo "<div class='offline'></div> <span class='text-default'>Dr. $allDoctor->name</span>"; ?>
