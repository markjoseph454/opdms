...
<button class="btn btn-flat btn-default" data-toggle="tooltip" title="Create a new blank consultation form"
        v-on:click="blank_consultation_form" >
    <img src="<?php echo e(asset('public/images/blank-consultation-form.svg')); ?>" class="img-responsive img-12 inline"  alt="">
...
<button class="btn btn-flat btn-default" data-toggle="tooltip" title="Request for medical certificate"
        v-on:click="blank_consultation_form" >
    <img src="<?php echo e(asset('public/images/medical-certificate.svg')); ?>" class="img-responsive img-12 inline"  alt="">
    <i class="fa fa-check icon_indicator"></i>
</button>
...
<button class="btn btn-flat btn-default" data-toggle="tooltip"
    ...
    <img src="<?php echo e(asset('public/images/smoke-cessation.svg')); ?>" class="img-responsive img-12 inline" />
    <i class="fa fa-check icon_indicator"></i>
</button>
...
<button class="btn btn-flat btn-default" data-toggle="tooltip" v-on:click.prevent="medical_records"
    ...
    <img src="<?php echo e(asset('public/images/medical-records.svg')); ?>" class="img-responsive img-12" />
</button>

<div class="inline pull-right">
    <button class="btn btn-flat btn-default" data-toggle="tooltip"
            title="Refer to other clinics" v-on:click.prevent="referral_insert">
        <img src="<?php echo e(asset('public/images/referrals.svg')); ?>" class="img-responsive img-12 inline" />
        <i class="fa fa-check icon_indicator"></i>
        Referrals
    </button>
    <button class="btn btn-flat btn-default" data-toggle="tooltip"
            title="Schedule for follow-up" v-on:click.prevent="followup_show">
        <img src="<?php echo e(asset('public/images/follow-up.svg')); ?>" class="img-responsive img-12 inline" />
        <i class="fa fa-check icon_indicator"></i>
        Follow-up
    </button>
    <button class="btn btn-flat btn-default" data-toggle="tooltip"
            title="Request ancillary items / services.">
        <img src="<?php echo e(asset('public/images/requisition.svg')); ?>" class="img-responsive img-12 inline" />
        <i class="fa fa-check icon_indicator"></i>
        Requisition
    </button>
    <button class="btn btn-flat btn-default" data-toggle="tooltip"
    ...
    v-on:click.prevent="icd_codes">
        <img src="<?php echo e(asset('public/images/icd-10-codes.svg')); ?>" class="img-responsive img-12 inline" />
        <i class="fa fa-check icon_indicator"></i>
        ICD 10 Codes
    </button>
    <button class="btn btn-flat btn-default" data-toggle="tooltip"
            title="Select RVS Code">
        <img src="<?php echo e(asset('public/images/rvs-codes.svg')); ?>" class="img-responsive img-12 inline" />
        <i class="fa fa-check icon_indicator"></i>
        RVS Codes
    </button>
</div>
