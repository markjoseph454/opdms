...
<?php $__env->startSection('vue-container-start'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <!-- Content Wrapper. Contains page content -->
            ...
            ['header' => 'Outgoing Referrals', 'sub' => 'Showing all patients that has been referred to other clinics.'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <section class="content container-fluid">
                    ...
                    <div class="box box-default bg-danger">
                        ...
                        <div class="box-header with-border">
                                <form action="<?php echo e(url('outgoing_referrals')); ?>" method="get" class="form-inline">
                                    ...
                                    <?php if($queues): ?>
                                        <?php $__currentLoopData = $queues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $queue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr v-on:click.prevent="patient_check($event, <?php echo e($queue->pid); ?>)">
                                                ...
                                                <td>
                                                    <strong class="text-primary text-uppercase">
                                                        DR. <?php echo e($queue->u_last_name.', '.$queue->u_first_name); ?>
                                                ...
                                                <td>
                                                    <?php echo e(Carbon::parse($queue->created_at)->toFormattedDateString()); ?>
