<div class="modal" id="modal-store-patient">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <form class="form-horizontal" id="store-form" method="POST" action="<?php echo e(url('patients')); ?>">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-8 col-sm-8 divider"> 
                                        ...
                                        <input type="text" name="address" class="form-control address store-address" action="store" id="address" placeholder="Enter Patient Address">
                                    </div>
                                    <div class="col-md-4 col-sm-4 divider">
                                    ...
                                    <input type="hidden" name="registeragain" class="registeragain">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12 col-sm-12 divider">
                                        ...
                                        <select name="clinic_code_store" class="form-control clinic_code select2" style="width: 100%;">
                                            <option value="" hidden=>--</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4 col-sm-4 divider">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-sm" id="savereg" form="store-form"><span class="fa fa-save"></span> Save & Register New</button>
                <button type="submit" class="btn btn-success btn-sm" id="saveclose" form="store-form"><span class="fa fa-save"></span> Save & Close</button>
            </div>
        </div>
    <!-- /.modal-content -->
    </div>
