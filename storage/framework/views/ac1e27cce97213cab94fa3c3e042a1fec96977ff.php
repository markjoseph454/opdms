...
<?php $__env->startSection('vue-container-start'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <!-- Content Wrapper. Contains page content -->
            ...
            ['header' => 'Age Gender Distribution Census', 'sub' => 'Showing all patients along with their acquired sickness.'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <!-- Main content -->
                <section class="content container-fluid">
                    ...
                    <div class="box box-default bg-danger">
                        ...
                        <?php echo $__env->make('OPDMS.reception.reports.diseases_census_search_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
