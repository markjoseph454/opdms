...
<?php $__env->startSection('pagestyle'); ?>
    ...
    <?php endif; ?>
    <link href="<?php echo e(asset('public/css/doctors/followup.css')); ?>" rel="stylesheet" />
    <style media="screen">
...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('doctors/dashboard'); ?>
        <?php $__env->startSection('main-content'); ?>
            ...
            <div class="content-wrapper" style="padding: 35px 10px">
                <br/>
                <br/>
                <div class="container-fluid followupWrapper">
                    <div class="col-md-12 row hidden-xs">
                        <h4><small>PATIENT NAME:</small> <?php echo e($patient->last_name.', '.$patient->first_name.' '.$patient->middle_name); ?></h4>
                        <h4><small>ADDRESS:</small> <?php echo e($patient->address); ?></h4>
                        <hr>
                    </div>
                    <div class="col-md-4 bg-danger followUpContainer">
