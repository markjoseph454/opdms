                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="facility">
                                    ...
                                    <?php $__currentLoopData = $facility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     <option value="<?php echo e($list->id); ?>"><?php echo e($list->hospital); ?></option>
                    ...
                    <div class="col-md-6">
                         <div class="form-group">
                            ...
                            <input type="" name="datetime" class="form-control" value="<?php echo e($date); ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="diagnosis">
                        <div class="table-responsive table-diagnosis" >
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $diagnosis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td align="center"><input type="checkbox" class="select-id" name="initial_id[]" style="height: 13px; width: 13px;" value="<?php echo e($list->id); ?>"></td>
                                            <td class="select-diagnosis"><?php echo e($list->diagnosis); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                ...
                <div class="out-patient">
                     <div class="form-group">
                        ...
                        <select name="refclinic" class="form-control">
                            ...
                            <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-group">
                            ...
                            <div class="table-responsive table-admitting-diagnosis">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $diagnosis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td align="center"><input type="checkbox" class="select-admitting-id" name="admitting_id[]" style="height: 13px; width: 13px;" value="<?php echo e($list->id); ?>"></td>
                                                <td class="select-admitting"><?php echo e($list->diagnosis); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
                     ...
                     <div class="form-group">
                        ...
                        <select name="area" class="form-control">
                            <option value="0" hidden>Select</option>
                            <?php $__currentLoopData = $ward; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($list->id); ?>"><?php echo e($list->ward); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
