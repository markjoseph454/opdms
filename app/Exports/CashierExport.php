    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A6:L'.$data.'')->applyFromArray($styleArray1);
                ...
                $event->sheet->getDelegate()->getStyle('A6:L8')->applyFromArray($styleArray2);
                $event->sheet->getDelegate()->getStyle('A1')->applyFromArray($styleArray2);
                $event->sheet->getDelegate()->getStyle('C2')->applyFromArray($styleArray2);
                ...
                $event->sheet->getDelegate()->getStyle('C2:D2')->applyFromArray($styleArray3);
                $event->sheet->getDelegate()->getStyle('C3:D3')->applyFromArray($styleArray3);
                $event->sheet->getDelegate()->getStyle('H2')->applyFromArray($styleArray3);
                ...
                $event->sheet->getDelegate()->getStyle('A'.($data+9).':L'.($data+9).'')->applyFromArray($styleArray3);
                $event->sheet->getDelegate()->getStyle('A'.($data+10).':L'.($data+10).'')->applyFromArray($styleArray3);
                $event->sheet->getDelegate()->getStyle('A'.($data+22).':L'.($data+22).'')->applyFromArray($styleArray3);
                ...
                ->setCellValue('H2', old('mreportno'))
                ->setCellValue('H4', Carbon::parse(old('transdate'))->format('M. d, Y'))
                ...
                /*=====CELL FORMAT=====*/
                $event->sheet->getDelegate()->getStyle('G'.$data.':L'.$data)->getNumberFormat()->setFormatCode(\PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1);
                ...
                /*=====CELL ALIGNMENT====*/
                $event->sheet->getDelegate()->getStyle('A6:L8')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                ...
                $event->sheet->getDelegate()->getStyle('A6:L8')->getAlignment()->setWrapText(true);
